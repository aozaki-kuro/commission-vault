...
export type CreatorMode = 'normalized' | 'raw'
export type CreatorSearchTextMode = CreatorMode | 'both'
...
export interface CommissionSearchMetadata {
  searchText: string
...
function resolveCreatorSuggestionTerm(
...
function resolveCreatorSearchTerms(
  rawCreatorName: string | null,
  normalizedCreatorName: string | null,
