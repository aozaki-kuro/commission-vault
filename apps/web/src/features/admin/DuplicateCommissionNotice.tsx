import type { DuplicateCommissionHint } from '#admin/duplicateCommissionHints'

interface DuplicateCommissionNoticeProps {
  hints: DuplicateCommissionHint[]
}

function DuplicateCommissionNotice({ hints }: DuplicateCommissionNoticeProps) {
  if (hints.length === 0)
    return null
...
export default DuplicateCommissionNotice
